...
/*!
 * @abstract Returns an array of values from a variable-length comma-separated list terminated by <code>nil</code>.
 */
FOUNDATION_EXPORT NSMutableArray *HCCollectItems(id item, va_list args);

/*!
 * @abstract Returns an array of matchers from a variable-length comma-separated list terminated by <code>nil</code>.
...
/*!
 * @abstract Returns an array of wrapped items from a variable-length comma-separated list terminated by <code>nil</code>.
